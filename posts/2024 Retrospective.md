...
Over the past year, one of the most significant changes in my career happened due to an internal reorganization at Microsoft. I moved from the Data Insights and Platforms team, where I worked on Spark Scala batch pipelines and big data infrastructure, to a new role on the Orders team within the Charge Lifecycle Platform organization. Shortly after making this shift, I was promoted, adding even more value to the transition.

![](/team-transition.png)

My new team focuses on managing the lifecycle of customer orders, developing Spark Streaming applications and .NET APIs to gather charges for end-of-month invoicing. This shift from building internal-facing, big data infrastructure to real-time, customer-facing systems has been both technically challenging and incredibly rewarding.

Since joining, I've gained practical experience with real-time data processing and deepened my understanding of how Microsoft manages order generation and customer billing on a large scale. A standout moment was designing and implementing a major feature from scratch to ensure data consistency in our aggregation flows, effectively tackling issues like dropped or missed data.
which play a critical role in verifying and correcting discrepancies across systems. -->

Additionally, I've been focused on reducing COGS (cost of goods sold) by enhancing performance and optimizing resource SKUs and configurations. This involves working closely with Azure ARM resources and navigating complex deployment processes. I've also simplified and standardized elements of our "recon" projects, which are crucial for verifying and correcting discrepancies across systems.

When it comes to developer productivity, I've been eliminating friction by implementing faster build and release pipelines—some up to four times quicker—and embracing AI tools like Roo Code, Copilot, GPT-4o, and Claude Sonnet 3.5 to boost and speed up engineering workflows.

![](/misc-tooling.png)

## 👨‍👩‍👧‍👦 Life Lately: Family First, and a Bit of Everything Else

As I write this, I'm still in the hospital awaiting discharge after the birth of our daughter, Tiffany Grace Fullerton, who joined us in late March 2025. She's healthy, happy, and full of life—truly a wonderful blessing. My wife Samantha is recovering well, and we're grateful everything went smoothly without any complications. We couldn’t have hoped for a better outcome.

![](/stork.png)

Becoming a father again has been both humbling and full of joy. Over the past year, I've been focusing more on family and less on hobbies like woodworking and music. However, I did tackle a few meaningful projects, including a complete bathroom renovation for our toddler son and new daughter. This involved everything from a new tub and shower tiles to flooring, drywall, plumbing, and a new vanity. It was a long, detailed project, but one I'm really proud of.
...
One of the greatest joys this past year has been watching our son reach milestone after milestone—his first steps, first words, and countless small moments in between. He has been an incredible source of joy, and being his dad has truly reshaped my priorities.
...
I'm also hoping to catch up on some personal projects that have been on hold, like renovating our deck and revisiting some woodworking projects I've been thinking about but haven't had a chance to work on. Working with my hands has always been a grounding outlet for me, and I'm eager to carve out some time for it again.
